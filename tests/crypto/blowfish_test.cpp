...
BOOST_AUTO_TEST_CASE(blowfish_chain_test)
{
    ...
    BOOST_CHECK_EQUAL( size_t(16), fc::from_hex( chain_test_key.c_str(), (char*) key, sizeof(key) ) );
    BOOST_CHECK_EQUAL( size_t(8), fc::from_hex( chain_test_iv.c_str(), (char*) iv, sizeof(iv) ) );

    BOOST_CHECK_EQUAL( size_t(32), fc::from_hex( chain_test_cbc.c_str(), (char*) cipher, sizeof(cipher) ) );
    fc::blowfish fish;
    ...
    BOOST_CHECK_EQUAL( size_t(29), fc::from_hex( chain_test_cfb.c_str(), (char*) cipher, sizeof(cipher) ) );
    fish.reset_chain();
